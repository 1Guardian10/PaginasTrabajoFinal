  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <HeroSection
        ...
        primaryButtonText="Únete a la Conservación"
        secondaryButtonText="Conocer Proyectos"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Nuestro centro especializado brinda atención médica veterinaria y rehabilitación a animales heridos o
                huérfanos. Trabajamos para devolverlos a su hábitat natural cuando están listos.
              </p>
      ...
      <CTASection
        ...
        primaryButtonText="Comenzar a Ayudar"
        secondaryButtonText="Conocer Más Programas"
